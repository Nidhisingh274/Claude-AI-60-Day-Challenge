...
## 🚀 Deliverables
- **Project Repository (v1.0.0 Release):** [MedGuide AI v1.0.0](https://github.com/Nidhisingh274/medguide-ai/releases/tag/v1.0.0)
- **Live Application:** [MedGuide AI](https://medguide-ai-7nzbirzxqusphhecrkvbns.streamlit.app/)

## 📂 Capstone Artifacts
*(Click the links below to view the respective files)*
- 📖 [Challenge Retrospective](./challenge-retrospective.md)
- 📈 [30-Day Growth Plan](./30-day-growth-plan.md)
- 🛠️ [Daily Build Prompt](./daily-build-prompt.md)
- 🔮 [Future Scope](./future-scope.md)

## 💡 Key Learnings (60-Day Journey & 10-Day Capstone)
- **Test the second interaction, not just the first:** Multiple real bugs (like the Chroma multi-connection issue and the silent `0.0` lab-value default) only appeared on a second question or specific input. A single happy-path test isn't enough.
- **Saying "no" is an engineering decision:** Choosing not to implement a trivially bypassable rate-limit or a risky BYOK feature at the last minute was as valuable as any feature that actually shipped. Protecting scope is crucial.
- **Documentation discipline compounds:** Documenting every architectural change and deviation daily (Days 2-9 addenda) made it possible to write a completely honest retrospective instead of reconstructing history from memory.
- **Connecting domain expertise to AI:** Building a tool inspired by real-world clinical data validation at ICMR proved that the best AI applications solve actual problems the builder understands deeply.

## 📄 Day 10 Prompt Used
<details>
<summary>Click to view the full Day 10 Prompt</summary>
...
### 10-Day Capstone Sprint Certificate of Completion
![Certificate](<img width="1122" height="791" alt="certificate" src="https://github.com/user-attachments/assets/6cbd0ab2-c7d3-4344-9e4d-588de2b359ee" />
)

### Graduation Skills Infographic
[Graduation Skills Infographic (PDF)](./skills-infographic.pdf)
